    ...
    return (
        ...
        <div className={`sidebar ${width}`}>
            ...
            <div className='tags tiles'>
                {tiles.map(tile => (<img src={`${import.meta.env.VITE_BASE_URL}img/${tile}.png`} key={tile} alt={tile} onClick={handleClickTile} className={`tag ${currentTile === tile && 'select'}`} title={tile} />))}
            </div>
            <div className='tags tiles'>
